...
The goal of [rocrateR](https://github.com/ResearchObject/ro-crate-r/) is
to provide an R package for creating, manipulating and reading
RO-Crates. Latest supported version of the specification:
...
| Function                                                                                                                                          | Purpose                                           |
|---------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| [`rocrate()`](reference/rocrate.md)                                                                                                               | Create an empty or initialized RO-Crate           |
| [`entity()`](reference/entity.md)                                                                                                                 | Define a new entity (Person, Dataset, etc.)       |
| [`add_entity()`](reference/add_entity.md) / [`add_entities()`](reference/add_entities.md)                                                         | Add entities to a crate                           |
| [`get_entity()`](reference/get_entity.md)                                                                                                         | Retrieve entities by `@id` or `@type`             |
| [`remove_entity()`](reference/remove_entity.md) / [`remove_entities()`](reference/remove_entities.md)                                             | Remove one or more entities                       |
| [`write_rocrate()`](reference/write_rocrate.md)                                                                                                   | Save RO-Crate to disk                             |
| [`bag_rocrate()`](reference/bag_rocrate.md) / [`is_rocrate_bag()`](reference/is_rocrate_bag.md) / [`unbag_rocrate()`](reference/unbag_rocrate.md) | Bagging and unbagging RO-Crates                   |
...
[`rocrateR::rocrate()`](reference/rocrate.md) function; however, you are
likely to include additional entities in your RO-Crate. Entities must
contain at least two components `@id` and `@type` (see
<https://w3id.org/ro/crate/1.2/> for details).
...
[`rocrateR::add_entity()`](reference/add_entity.md) function:
...
([`rocrateR::get_entity()`](reference/get_entity.md)) and remove
([`rocrateR::remove_entities()`](reference/remove_entities.md)).
...
[`rocrateR::bag_rocrate`](reference/bag_rocrate.md) will take either a
...
RO-Crate object created with [`rocrateR::rocrate`](reference/rocrate.md)
...
[`rocrateR::is_rocrate_bag()`](reference/is_rocrate_bag.md) to verify
that a given path points to a ZIP file or a directory with a valid
RO-Crate bag. The expected files are
