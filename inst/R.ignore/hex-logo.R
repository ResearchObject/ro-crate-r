...
#' @keywords internal
hex_logo <- function(subplot = system.file("images/ro-crate-w-text.png", 
                                           package = "rocrateR"),
                     dpi = 600,
                     h_color = "#000000",
                     h_fill = "#FFFFFF",
  ...
  hexSticker::sticker(subplot = subplot, package = package,
                      ...
                      dpi = dpi,
                      s_x = 1.0, s_y = 1.0, s_width = .7,
                      p_x = 1.0, p_y = 1.52, p_size = 20, p_color = p_color,
                      url = url,
                      u_angle = 30, u_color = p_color, u_size = u_size, u_y = 0.06,
                      filename = output)
}
